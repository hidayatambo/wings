...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 shadow"
        id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                ...
                <span class="ms-1 font-weight-bold">Penjualan Dashboard</span>
            </a>
        </div>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <nav class="navbar navbar-main navbar-expand-lg px-2 mt-4 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            navbar-scroll="true">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end"
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="/cart" class="btn mt-3 btn-light">
                                <img class="me-sm-1 pr-5" width="25" height="25" src="admin/assets/img/cart.svg"
                                alt="" srcset="">
                                    ...
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                <span class="text-sm font-weight-normal  font-weight-bold">Keluar</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
    ...
    <script src="admin/assets/js/detail.js"></script>
</body>
